...
PRIVACY_BUDGETS = [1,2,4,6,8,10] # np.arange(0.1, 1.0, 0.1) # [1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5]
...
NB_TREES_PER_ENSEMBLE = 50              # changed params json to 40 trees!
...
if __name__ == '__main__':
  ...
  output = open(PATH + 'results_alltrees_40_' + now + '.csv', 'a')
