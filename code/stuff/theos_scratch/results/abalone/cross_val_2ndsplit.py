...
PRIVACY_BUDGETS = np.arange(0.1, 1.0, 0.1) # [1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5] # = np.arange(0.1, 1.0, 0.1)
...
if __name__ == '__main__':
  ...
  output = open(PATH + 'results_2ndsplit_noifbinary_leafclipping_' + now + '.csv', 'a')
