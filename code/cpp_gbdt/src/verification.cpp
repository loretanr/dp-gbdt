...
int Verification::main(int argc, char *argv[])
{
    ...
    datasets.push_back(parser.get_YearPredictionMSD2(parameters, 300, true)); // small yearMSD
    ...
    datasets.push_back(parser.get_adult2(parameters, 320, true)); // small adult
