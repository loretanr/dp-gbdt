...
def create_plot(filename, ymin, ymax):
    ...
    # plot the baseline
    plt.axhline(y = 24.7, color = 'mediumseagreen', linestyle = '--')
    plt.annotate('baseline (0-R)', xy=(0.11, 23), xycoords='data', color = 'mediumseagreen')
    ...
    plt.yticks([13] + np.arange(15, ymax+1, 5).tolist())
