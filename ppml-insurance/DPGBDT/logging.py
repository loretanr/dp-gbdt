...
## NOTE: This code was written by myself while interning at Google. Since it
# is under the Apache 2.0 license, I am free to re-use it as needed.
# Source: https://github.com/google/cloud-forensics-utils/blob/master/
